...
@WebServlet(name = "OrdersEditor", urlPatterns = {"/orders/editor"})
public class OrdersEditor extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (vehicleId != null && id > 0) {
            Order order = new Order(id, plannedStart, start, employeeId, problemDesc, repairDesc, statusId, vehicleId, totalCost, partsCost, hoursSpent);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/WEB-INF/views/orders-editor.jsp").forward(request, response);
    }
}
